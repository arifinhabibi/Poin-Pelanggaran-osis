        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('beranda') }}">
                <div class="sidebar-brand-icon">
                    <img src="/assets/img/jurusan/nesas.png" style="width: 50px" alt="">
                </div>
                <div class="sidebar-brand-text mx-3">Poin Siswa</div>
            </a>
            ...
            <li class="nav-item {{ request()->is('admin-kontrol', 'admin-kontrol/tambah-jurusan', 'admin-kontrol/data-siswa/{id}') ? 'active' : '' }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Hak Cipta&copy; VanderCode {{ date('Y') }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
